...
def run_RNN(X, labels, path_to_glove, MNW, LSTMD, ATT, OPT, experimental_mode, oversampling, model_name):
...
if '__main__' == __name__:
    ...
    run_RNN(train, labels, path_to_glove, MNW, LSTMD, ATT, OPT, experimental_mode, oversampling, "RNN_%s_%s_%s_%s_%s_%s" % (str(X), str(MNW), str(LSTMD), str(ATT), str(OPT), str(oversampling)))
