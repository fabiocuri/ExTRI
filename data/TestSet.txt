...
Baseline Data
-------------
NLM produces a baseline set of MEDLINE/PubMed citation records in XML format for download on an annual basis. The annual baseline is released in December of each year. The complete baseline consists of files pubmed19n0001 through pubmed18n0972. ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline 


Daily Update Files
------------------
Each day, NLM produces update files that include new, revised and deleted citations. The first Update file to be loaded after loading the complete set of 2019 MEDLINE/PubMed Baseline files is pubmed18n0973.xml. ftp://ftp.ncbi.nlm.nih.gov/pubmed/updatefiles
...
--------------------
Downloading PubMed data from the National Library of Medicine FTP servers indicates your acceptance of the following Terms and Conditions. No charges, usage fees or royalties are paid to NLM for this data.  
